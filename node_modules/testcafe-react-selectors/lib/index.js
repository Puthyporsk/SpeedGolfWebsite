...
const ReactSelector = exports.ReactSelector = (0, _testcafe.Selector)(selector => {
    ...
    const getRootElsReact16or17 = /*global document*/
    ...
    const selectorReact16or17 = /*global window document Node rootEls defineSelectorProperty visitedRootEls checkRootNodeVisited*/
    ...
    getReact: (node, fn) => {
        ...
        const react16or17Utils = /*global window Node*/
        function () {
            const ELEMENT_NODE = 1;
            const COMMENT_NODE = 8;
        ...
        if (reactVersion === '16|17') return react16or17Utils.getReact(node, fn);
    }
}).addCustomMethods({
    withProps: (nodes, ...args) => {
        ...
        let getComponentForDOMNode = reactVersion === '15' ? react15Utils.getComponentForDOMNode : react16or17Utils.getComponentForDOMNode;
    ...
    findReact: (nodes, selector) => {
        ...
        let scanDOMNodeForReactComponent = reactVersion === '15' ? react15Utils.scanDOMNodeForReactComponent : react16or17Utils.scanDOMNodeForReactComponent;
